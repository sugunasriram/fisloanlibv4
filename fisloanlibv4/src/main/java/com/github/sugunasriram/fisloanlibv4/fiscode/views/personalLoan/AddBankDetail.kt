...
import com.github.sugunasriram.fisloanlibv4.fiscode.components.SideMenuTextButton
...
//                }else
                if (errorMessage.contains("Adding bank account exceeds", ignoreCase = true)) {
...
@Preview
@Composable
fun AddBankDetailViewPreview(){
    AddBankDetailView(
        bankDetailCollecting = false,
        bankDetailCollected = false,
        fromFlow = "Personal Loan",
        bankDetailResponse = null,
        gstBankDetailResponse = null,
        ...
        focusAccountHolder = FocusRequester.Default,
        focusAccountNumber = FocusRequester.Default,
        focusAccountType = FocusRequester.Default,
        focusIfscCode = FocusRequester.Default,
        ifscCodeError = null,
        fromScreen = "Add New Bank"
    )
}
