...
import com.github.sugunasriram.fisloanlibv4.fis_code.components.TextValueInARow
import com.github.sugunasriram.fisloanlibv4.fis_code.components.VerticalDivider
...
import com.github.sugunasriram.fisloanlibv4.fis_code.ui.theme.normal35Text700
import com.github.sugunasriram.fisloanlibv4.fis_code.ui.theme.whiteGreenColor
import com.github.sugunasriram.fisloanlibv4.fis_code.views.StatusCard
...
fun LoanStatusDetailScreen(navController: NavHostController) {
    ...
    ScreenWithHamburger(isSelfScrollable = false, navController = navController) {
        RegisterText(
            text = stringResource(id = R.string.loan_status_detail),
            textColor = appBlueTitle,
            bottom = 20.dp,
            top = 20.dp,
            style = normal35Text700
        )
        ...
        StatusCard(
            processDone = true,
            showSubText = false,
            cardText = stringResource(id = R.string.approved),
