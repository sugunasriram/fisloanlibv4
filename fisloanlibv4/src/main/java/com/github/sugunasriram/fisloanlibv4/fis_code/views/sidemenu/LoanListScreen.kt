...
import com.github.sugunasriram.fisloanlibv4.fis_code.navigation.navigateLoanStatusDetailScreen
import com.github.sugunasriram.fisloanlibv4.fis_code.ui.theme.appBlueTitle
import com.github.sugunasriram.fisloanlibv4.fis_code.ui.theme.hyperTextColor
        ...
        LazyColumn {
            items(6) { item ->
                if (item == 0) {
                    ...
                    RegisterText(
                        text = stringResource(id = R.string.loan_list),
