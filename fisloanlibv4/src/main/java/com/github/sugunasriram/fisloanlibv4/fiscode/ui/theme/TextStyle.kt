...
val normal16Text500Orange = TextStyle(
    fontSize = 16.sp,
    fontFamily = FontFamily(Font(R.font.robotocondensed_regular)),
    fontWeight = FontWeight(500),
    color = appOrange
...
val semiBold24Text700 = TextStyle(
    fontSize = 24.sp,
    fontFamily = FontFamily(Font(R.font.robotocondensed_semibold)),
    fontWeight = FontWeight(700)
)

val bold16Text400 = TextStyle(
    fontSize = 16.sp,
    lineHeight = 22.sp,
    fontFamily = FontFamily(Font(R.font.robotocondensed_semibold)),
    fontWeight = FontWeight(400),
